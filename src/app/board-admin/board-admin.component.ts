...
export class BoardAdminComponent implements OnInit {
  ...
  edit(record: InventoryRecord): void { this.editing = record; this.form = { ...record }; if (this.resource === 'grupos-venta') { this.form['categoriaNombre'] = this.lookupName(this.categories, record['categoriaId'] ?? record['idCategoria']); this.form['subcategoriaNombre'] = this.lookupName(this.subcategories, record['subcategoriaId'] ?? record['idSubcategoria']); } this.success = ''; }
  ...
  displayField(record: InventoryRecord, field: string): string {
    const aliases: Record<string, string[]> = {
      ...
      telefono: ['telefono', 'celular', 'telefonoContacto'],
      email: ['email', 'correo'],
      categoriaId: ['categoriaId', 'idCategoria', 'categoria_id'],
      subcategoriaId: ['subcategoriaId', 'idSubcategoria', 'subcategoria_id'],
      grupoVentaId: ['grupoVentaId', 'idGrupoVenta', 'grupo_venta_id'],
      proveedorId: ['proveedorId', 'idProveedor', 'proveedor_id']
    };
